...
(function implement_this_file_type_robustly_js()
{
    ...
    is = (function the_is_object()
    {
        ...
        return Object.create(Object.prototype,
        {
            ...
            errorVariant:
            {
                value:function(x)
                {
                    return typeof(x) === 'object' && toString.call(x) === "[object Error]";
                }
            },
            setIterator:
            {
            ...
            Uint8ClampedArray:
            {
                value:function(x)
                {
                    return type(x) === "Uint8ClampedArray";
                }
            },
            Int16Array:
            {
    ...
    (function type_the_es6_like_classes()
    {
        ...
        Object.defineProperty(Date.prototype, typeSymbol,
        {
            value:function()
            {
                return nativeType(this);
        ...
        {
            Object.defineProperty(AggregateError.prototype, typeSymbol,
            {
                value:function()
                {
                    if(this === AggregateError.prototype) return "Object";
                    return nativeType(this) === "Error"? "AggregateError":"Object";
                }
            });

            Object.defineProperty(is, "AggregateError",
            {
                value:function(x)
                {
                    return type(x) === "AggregateError";
                }
            })
        }
        ...
        {
            Object.defineProperty(Buffer.prototype, typeSymbol,
            {
                value:function()
                {
                    if (nativeType(this) === "Uint8Array") return "Buffer";
                    return "Object";
                }
            });

            Object.defineProperty(is, "Buffer",
            {
                value:function(x)
                {
                    return type(x) === "Buffer";
                }
            })
        }
        ...
        Object.defineProperty(BigInt64Array.prototype, typeSymbol,
        {
            value:function()
            {
                return nativeType(this);
        ...
        Object.defineProperty(BigUint64Array.prototype, typeSymbol,
        {
            value:function()
            {
                return nativeType(this);
        ...
        {
            Object.defineProperty(WeakRef.prototype, typeSymbol,
            {
                value:function()
                {
                    if(this === WeakRef.prototype) return "Object";
                    try {WeakRef.prototype.deref.call(this); } catch (e) { return "Object"; }
                    return "WeakRef";
                }
            });

            Object.defineProperty(is, "WeakRef",
            {
                value:function(x)
                {
                    return type(x) === "WeakRef";
                }
            })
        }
        ...
        Object.defineProperty(ArrayBuffer.prototype, typeSymbol,
        {
            value:function()
            {
                ...
                try {ArrayBuffer.prototype.slice.call(this,0,0);} catch (e) {return "Object"; }
                return "ArrayBuffer";
            }
        });
        ...
        {
            Object.defineProperty(Blob.prototype, typeSymbol,
            {
                value:function()
                {
                    if(this === Blob.prototype) return "Object";
                    if(Object.getPrototypeOf(this) !== Blob.prototype) return "Object"
                    try {
                        Blob.prototype.slice.call(this,0,0);
                        return "Blob";
        ...
        Object.defineProperty(DataView.prototype, typeSymbol,
        {
            value:function()
            {
                ...
                try {DataView.prototype.getUint8.call(this,0);} catch (e) { return "Object"; }
                return "DataView";
            }
        });
        ...
        Object.defineProperty(Promise.prototype, typeSymbol,
        {
            value:function()
            {
                if(this === Promise.prototype) return "Object";
                return Object.getPrototypeOf(this) === Promise.prototype? "Promise" : "Object";
            }
        });
